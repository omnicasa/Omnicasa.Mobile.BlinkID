...
*/
    [Protocol]
    interface MBOverlayContainerViewController : IMBRecognizerRunnerViewController
    {
...
*/
    ...
    interface MBRecognizerRunner
    {
        ...
        // @property (nonatomic) MBCoordinator * _Nullable coordinator;
        [NullAllowed, Export("coordinator", ArgumentSemantic.Assign)]
...
*/
    [Protocol]
    interface MBEncodeSignatureImage
    {
...
*/
    [Protocol]
    interface MBClassAnonymization
    {
...
*/
    ...
    interface IMBCombinedRecognizer
    {
        ...
        MBCombinedRecognizerResult CombinedResult { get; }
    }
